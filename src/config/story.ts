...
export type SoundKey = 'musicBox' | 'softClick' | 'none'
...
export const storyItems: Record<StoryItemId, StoryItem> = {
  ...
  computer: {
    ...
    body: [
      '我好像一直对各种有创意的东西毫无抵抗力。',
      '上学的时候特别喜欢看手书视频，后来又沉迷过定格动画、创意剪辑、AI 创意视频这类东西。经常刷着刷着就开始研究：“这个到底是怎么做出来的？”有时候甚至会因为一个几秒钟的转场效果反复看好多遍。',
      '平时看到有设计感的小饰品、包装、海报或者一些有趣的视觉创意，也总会忍不住收藏下来。别人收藏照片，我收藏灵感。',
      '后来接触 AI 的时候，我的第一反应不是“这个效率好高”，而是：“哇，那些以前停留在脑子里的想法，好像真的能做出来了。”',
      '于是开始各种折腾。做过西兰花 BROCCOLI 这样的可爱 IP，做过 AI 短片、创意海报，也给活动设计过各种物料。',
      '虽然经常一研究就是大半天，但每次看到脑海里的东西一点点变成真实作品的时候，都会有种特别满足的感觉。',
      '我喜欢的好像从来不是某个具体工具，而是把一个想法从 0 到 1 做出来的过程。',
      '目前也在努力往 AI 运营、AI 产品方向探索。如果你也喜欢折腾有趣的项目，欢迎来找我玩！',
    ],
  },
  photoWall: {
    id: 'photoWall',
    ...
    body: [
      '我参与策划过十多场线上线下活动。',
      '有在 KTV 里的开说，有在海底捞里的演讲，最特别的是，我还在猫咖办过一场演出。那天的观众除了人，还有猫。那种感觉很奇妙，空间一下子变得很柔软。',
      '我很喜欢这种把人聚在一起的时刻。大家原本是陌生人，但因为一个话题、一个故事、一次活动，突然产生了一点连接。',
      '我也很喜欢认识各种有意思的人，哪怕只是聊上几句，也会觉得世界又变大了一点。',
    ],
  },
  giftBox: {
    id: 'giftBox',
